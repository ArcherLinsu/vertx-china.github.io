...
----
dependencies {
 compile 'io.vertx:vertx-codegen:4.3.3:processor'
 compile 'io.vertx:vertx-web-api-service:4.3.3'
}
----
...
----
dependencies {
 annotationProcessor 'io.vertx:vertx-codegen:4.3.3:processor'
 annotationProcessor 'io.vertx:vertx-web-api-service:4.3.3'
 compile 'io.vertx:vertx-web-api-service:4.3.3'
}
----
