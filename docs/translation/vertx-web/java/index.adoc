...
----
dependencies {
 compile 'io.vertx:vertx-web:4.3.1'
}
----
...
access. You need to add the `io.vertx:vertx-auth-jwt:4.3.1` dependency to use `JWTAuthProvider`
...
`io.vertx:vertx-web-templ-mvel:4.3.1`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:4.3.1`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:4.3.1`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:4.3.1`. Create an instance of the Thymeleaf template engine
...
`io.vertx:vertx-web-templ-freemarker:4.3.1`. Create an instance of the Apache FreeMarker template engine
...
`io.vertx:vertx-web-templ-pebble:4.3.1`. Create an instance of the Pebble template engine
...
To use Rocker, then add `io.vertx:vertx-web-templ-rocker:4.3.1` as a dependency to your project.
...
`io.vertx:vertx-web-templ-httl:4.3.1`. Create an instance of the HTTL template engine
...
`io.vertx:vertx-web-templ-rythm:4.3.1`. Create an instance of the Rythm template engine
