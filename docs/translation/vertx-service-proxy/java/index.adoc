...
----
compile 'io.vertx:vertx-service-proxy:4.3.7'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:4.3.7'
----
* Gradle >= 5 (in your `build.gradle` file):

[source,groovy,subs="+attributes"]
----
annotationProcessor 'io.vertx:vertx-codegen:4.3.7:processor'
annotationProcessor 'io.vertx:vertx-service-proxy:4.3.7'
----
...
[source]
----
compile "io.vertx:vertx-codegen:4.3.7:processor"
compile "io.vertx:vertx-service-proxy:4.3.7"
----
