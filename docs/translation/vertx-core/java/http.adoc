...
NOTE: use `link:../../apidocs/io/netty/handler/codec/compression/StandardCompressionOptions.html[StandardCompressionOptions]` static methods to create `link:../../apidocs/io/netty/handler/codec/compression/CompressionOptions.html[CompressionOptions]`
...
This feature is disabled by default, however you can enable it using `link:../../apidocs/io/vertx/core/http/HttpServerOptions.html#setRegisterWebSocketWriteHandlers-boolean-[setRegisterWebSocketWriteHandlers]` or `link:../../apidocs/io/vertx/core/http/WebSocketConnectOptions.html#setRegisterWriteHandlers-boolean-[setRegisterWriteHandlers]`.
