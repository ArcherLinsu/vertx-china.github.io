...
This feature is disabled by default, however you can enable it using `link:../../apidocs/io/vertx/core/net/NetServerOptions.html#setRegisterWriteHandler-boolean-[setRegisterWriteHandler]` or `link:../../apidocs/io/vertx/core/net/NetClientOptions.html#setRegisterWriteHandler-boolean-[setRegisterWriteHandler]`.
