...
----
compile 'io.vertx:vertx-service-proxy:4.3.5'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:4.3.5'
----
* Gradle >= 5（在您的 `build.gradle` 文件中）：

[source,groovy,subs="+attributes"]
----
annotationProcessor 'io.vertx:vertx-codegen:4.3.5:processor'
annotationProcessor 'io.vertx:vertx-service-proxy:4.3.5'
----
...
[source]
----
compile "io.vertx:vertx-codegen:4.3.5:processor"
compile "io.vertx:vertx-service-proxy:4.3.5"
----
