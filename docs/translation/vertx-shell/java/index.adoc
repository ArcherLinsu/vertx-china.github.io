...
----
vertx run -conf '{"telnetOptions":{"port":5000}}' maven:io.vertx:vertx-shell:4.3.8
----
...
# start the shell
vertx run -conf '{"sshOptions":{"port":4000,"keyPairOptions":{"path":"ssh.jks","password":"secret"},"authOptions":{"provider":"properties","config":{"file":"file:auth.properties"}}}}' maven:io.vertx:vertx-shell:4.3.8
----
...
# create the auth config
echo user.admin=password > auth.properties
vertx run -conf '{"httpOptions":{"port":8080,"ssl":true,"keyStoreOptions":{"path":"keystore.jks","password":"secret"},"authOptions":{"provider":""properties,"config":{"file":"file:auth.properties"}}}}' maven:io.vertx:vertx-shell:4.3.8
----
...
or `maven:io.vertx:vertx-shell:4.3.8`
...
- `link:../../apidocs/io/vertx/ext/auth/ldap/LdapAuthenticationOptions.html[LdapAuthenticationOptions]` for LDAP
- `link:../../apidocs/io/vertx/ext/auth/jdbc/JDBCAuthenticationOptions.html[JDBCAuthenticationOptions]` for JDBC
- `link:../../apidocs/io/vertx/ext/auth/mongo/MongoAuthenticationOptions.html[MongoAuthenticationOptions]` for Mongo
...
Alternatively, an `link:../../apidocs/io/vertx/ext/auth/authentication/AuthenticationProvider.html[AuthenticationProvider]` can be `link:../../apidocs/io/vertx/ext/shell/term/TermServer.html#authenticationProvider-io.vertx.ext.auth.authentication.AuthenticationProvider-[set]`
